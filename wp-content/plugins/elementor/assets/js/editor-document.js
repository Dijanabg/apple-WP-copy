...
$e.modules.document = {
  get CommandHistory() {
    elementorCommon.helpers.softDeprecated('$e.modules.document.CommandHistory', '3.5.0', '$e.modules.editor.document.CommandHistoryBase');
    return $e.modules.editor.document.CommandHistoryBase;
  },

  get CommandHistoryDebounce() {
    elementorCommon.helpers.softDeprecated('$e.modules.CommandHistoryDebounce', '3.5.0', '$e.modules.editor.document.CommandHistoryDebounceBase');
